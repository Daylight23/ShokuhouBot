...
import misaki.modules.sql.global_bans_sql as sql
from misaki import (
    dispatcher,
    OWNER_ID,
    SUDO_USERS,
...
from misaki.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from misaki.modules.sql.users_sql import get_all_chats
        ...
        if old_reason:
            ...
            context.bot.sendMessage(
                ...
                "\n<b>New Reason:</b> {}".format(
                    mention_html(bannerid, bannername),
                    mention_html(
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @chiruzon if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
Misaki will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
