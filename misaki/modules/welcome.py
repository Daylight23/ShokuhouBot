...
import misaki.modules.sql.welcome_sql as sql
from misaki import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from misaki.modules.helper_funcs.alternate import typing_action
from misaki.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from misaki.modules.helper_funcs.misc import build_keyboard, revert_buttons
from misaki.modules.helper_funcs.msg_types import get_welcome_type
from misaki.modules.helper_funcs.string_handling import (
    markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from misaki.modules.log_channel import loggable
from misaki.modules.sql.global_bans_sql import is_user_gbanned
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our chat, @chiruzon".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Misaki have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
