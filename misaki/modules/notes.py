...
from misaki import dispatcher, MESSAGE_DUMP, LOGGER
...
from misaki.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from misaki.modules.helper_funcs.misc import build_keyboard, revert_buttons
from misaki.modules.helper_funcs.msg_types import get_note_type
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names."
            )
